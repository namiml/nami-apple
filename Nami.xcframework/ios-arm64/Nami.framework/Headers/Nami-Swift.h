...
///
/// \param completion An optional completion handler returning success or error.
///
+ (void)setExternalIdentifierWithExternalIdentifier:(NSString * _Nullable)externalIdentifier type:(enum NamiExternalIdentifierType)type completion:(void (^ _Nullable)(BOOL, NSError * _Nullable))completion;
...
+ (void)clearExternalIdentifierWithCompletion:(void (^ _Nullable)(BOOL, NSError * _Nullable))completion;
...
+ (void)registerJourneyStateChangedHandler:(void (^ _Nullable)(CustomerJourneyState * _Nonnull))changeHandler;
@end
