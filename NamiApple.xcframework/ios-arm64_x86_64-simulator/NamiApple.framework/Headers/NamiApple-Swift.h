...
- (nonnull instancetype)initWithNamiId:(NSString * _Nonnull)namiId storeId:(NSString * _Nonnull)storeId skuType:(enum NamiSKUType)skuType product:(SKProduct * _Nullable)product OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
