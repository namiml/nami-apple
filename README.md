...
* Library of smart paywall templates to choose from, implemented natively using UIKit and SwiftUI 
...
### Add Manually
The Nami XCFramework is available via the Swift Package Manager or Cocoapods. You may also add the XCFramework manually to your project. If you are using Xcode 11, you need to use this option. Learn the details[here](https://docs.namiml.com/v2.0/docs/xcode-11).
