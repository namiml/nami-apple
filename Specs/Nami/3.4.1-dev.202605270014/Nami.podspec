Pod::Spec.new do |s|
  s.name             = 'Nami'
  s.version          = '3.4.1-dev.202605270014'
  ...
  s.source           = { :http => "https://packages.namiml.com/NamiSDK/Apple/3.4.1-dev.202605270014/NamiApple.xcframework-3.4.1-dev.202605270014-cocoapods.zip" }
