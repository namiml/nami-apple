...
///
/// \param errorHandler Handler to be invoked if a campaign cannot be launched due to an error.
///
+ (void)launchWithLabel:(NSString * _Nullable)label waitOnData:(double)waitOnData errorHandler:(void (^ _Nullable)(NSError * _Nullable))errorHandler;
@end
...
///
+ (void)registerJourneyStateHandler:(void (^ _Nullable)(CustomerJourneyState * _Nonnull))changeHandler;
...
/// Provides the Nami SDK with an entitlemnet your application wishes to revoke.  Please ensure the entitlement names match the ones you define in the Nami Control Center for your application.  Any changes with entitlement reference IDs that do not match will be discarded.
/// Any entitlement granted will stay active until you pass in a new entitlement, or it is revoked by the server or a call to <code>revokeExternal</code>
/// \param referenceId Name of entitlment defined in Nami Control Center.
///
...
///
+ (void)renderCustomUiHandler:(void (^ _Nullable)(UIViewController * _Nullable, NSArray<NamiSKU *> * _Nullable, NSString * _Nonnull, NamiPaywall * _Nonnull))applicationPaywallHandler;
...
///
+ (void)registerClosedHandler:(void (^ _Nullable)(BOOL, NSDictionary<NSString *, id> * _Nonnull, NamiPaywall * _Nullable))paywallClosedHandler;
...
@property (nonatomic, readonly, copy) NSString * _Nullable namiDisplayText;
@property (nonatomic, readonly, copy) NSString * _Nullable namiSubDisplayText;
