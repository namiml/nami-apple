Pod::Spec.new do |s|
  s.name             = 'Nami'
  s.version          = '3.4.0-dev.202605131637'
  ...
  s.source           = { :http => "https://packages.namiml.com/NamiSDK/Apple/3.4.0-dev.202605131637/NamiApple.xcframework-3.4.0-dev.202605131637-cocoapods.zip" }
