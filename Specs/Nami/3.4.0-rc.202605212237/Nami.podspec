Pod::Spec.new do |s|
  s.name             = 'Nami'
  s.version          = '3.4.0-rc.202605212237'
  ...
  s.source           = { :http => "https://packages.namiml.com/NamiSDK/Apple/3.4.0-rc.202605212237/NamiApple.xcframework-3.4.0-rc.202605212237-cocoapods.zip" }
