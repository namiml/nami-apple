Pod::Spec.new do |s|
  s.name             = 'Nami'
  s.version          = '3.4.9-dev.202608121716'
  ...
  s.source           = { :http => "https://packages.namiml.com/NamiSDK/Apple/3.4.9-dev.202608121716/NamiApple.xcframework-3.4.9-dev.202608121716-cocoapods.zip" }
