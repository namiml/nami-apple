...
///
+ (void)loginWithId:(NSString * _Nonnull)id type:(enum NamiExternalIdentifierType)type;
...
/// \param refeshHandler Called when the entitlement check has returned from Nami and system entitlments updated.
///
+ (void)refresh;
/// Asks Nami to update internal entitlements, if an action has been taken you feel might have affected entitlements recently and you would like to check.
/// \param refeshHandler Called when the entitlement check has returned from Nami and system entitlments updated.
///
+ (void)refresh:(void (^ _Nullable)(NSArray<NamiEntitlement *> * _Nonnull))refeshHandler;
