...
///
+ (void)launchWithLabel:(NSString * _Nullable)label launchHandler:(void (^ _Nullable)(BOOL, NSError * _Nullable))launchHandler paywallActionHandler:(void (^ _Nullable)(enum NamiPaywallAction, NSString * _Nullable))paywallActionHandler;
/// Presents a paywall for a campaign with the selection of the paywall and paywall loading affected by the parameters passed in as listed below.
/// \param label Campaign label defined in Nami Control Center for launching a specific campaign.
///
/// \param waitOnData Maximum timeout for image and product loading, in seconds.  Default is 2.0 seconds.
...
/// \param paywallActionHandler Handler to be invoked when a paywall action occurs during this launch.
///
+ (void)launchWithLabel:(NSString * _Nullable)label waitOnData:(double)waitOnData launchHandler:(void (^ _Nullable)(BOOL, NSError * _Nullable))launchHandler paywallActionHandler:(void (^ _Nullable)(enum NamiPaywallAction, NSString * _Nullable))paywallActionHandler;
@end
...
///
+ (void)registerClosedHandler:(void (^ _Nullable)(UIViewController * _Nullable))paywallClosedHandler;
