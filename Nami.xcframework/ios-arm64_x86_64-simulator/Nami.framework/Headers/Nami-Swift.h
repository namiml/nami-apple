...
/// A pre-cached background image for the paywall, if one is available.  Nami will attempt to pre-load paywall assets so there is no delay presenting paywalls.
