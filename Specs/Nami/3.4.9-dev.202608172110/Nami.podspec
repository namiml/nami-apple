Pod::Spec.new do |s|
  s.name             = 'Nami'
  s.version          = '3.4.9-dev.202608172110'
  ...
  s.source           = { :http => "https://packages.namiml.com/NamiSDK/Apple/3.4.9-dev.202608172110/NamiApple.xcframework-3.4.9-dev.202608172110-cocoapods.zip" }
